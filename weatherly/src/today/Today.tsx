...
export default function today(props: any) {
  ...
  return(
        ...
        <div>
            ...
            <h2 className='wind'>
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="wind" className="svg-inline--fa fa-wind fa-2xl " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
